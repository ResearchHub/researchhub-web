...
export const textEditorIcons = {
  ...
  h2: <FontAwesomeIcon icon={faH2}></FontAwesomeIcon>,
  h3: <FontAwesomeIcon icon={faH3}></FontAwesomeIcon>,
  h4: <FontAwesomeIcon icon={faH4}></FontAwesomeIcon>,
  h5: <FontAwesomeIcon icon={faH5}></FontAwesomeIcon>,
  h6: <FontAwesomeIcon icon={faH6}></FontAwesomeIcon>,
  paragraph: <FontAwesomeIcon icon={faParagraph}></FontAwesomeIcon>,
  ...
  checkList: <FontAwesomeIcon icon={faListCheck}></FontAwesomeIcon>,
  ...
  horizontalRule: <FontAwesomeIcon icon={faHorizontalRule}></FontAwesomeIcon>,
  pageBreak: <FontAwesomeIcon icon={faFileDashedLine}></FontAwesomeIcon>,
  alignLeft: <FontAwesomeIcon icon={faAlignLeft}></FontAwesomeIcon>,
  alignCenter: <FontAwesomeIcon icon={faAlignCenter}></FontAwesomeIcon>,
