...
const icons = {
  ...
  compass: <FontAwesomeIcon icon={faCompass} />,
...
export const CloseIcon = ({ onClick, width = 14, height = 14, withAnimation = true, styleVariation = null }) => {
  return (
    <span onClick={onClick} className={css(styles.iconWrapper, withAnimation && styles.withAnimation, styleVariation && styles[styleVariation])}>
