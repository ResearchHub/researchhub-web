...
if (process.browser) {
  ...
  QuillPeerReviewRatingBlock = class QuillPeerReviewRatingBlock extends (
    BlockEmbed
  ) {
    static create(value) {
    ...
    attach() {
      super.attach();
      const isReadOnly =
        this.parent.domNode.getAttribute("contenteditable") === "false";
    ...
    deleteAt(index: number, length: number) {
      const isImmutable =
        String(this.domNode.getAttribute("data-immutable")) === "true";
      if (isImmutable) {
        return false;
      }
