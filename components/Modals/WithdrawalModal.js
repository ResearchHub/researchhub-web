...
const styles = StyleSheet.create({
  ...
  tab: {
    ...
    fontWeight: 500,
    cursor: "pointer",
    backgroundColor: colors.VERY_DARK_BLUE(0.2),
    borderLeft: `1px solid ${colors.LIGHT_GRAYISH_BLUE2()}`,
    borderRight: `1px solid ${colors.LIGHT_GRAYISH_BLUE2()}`,
    borderBottom: `1px solid ${colors.LIGHT_GRAYISH_BLUE2()}`,
    color: colors.VERY_DARK_BLUE(0.6),
    ":hover": {
      color: colors.BLUE(),
    },
  },
