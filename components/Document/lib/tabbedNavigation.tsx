...
export const tabs: Array<Tab> = [
  ...
  {
    icon: <ResearchCoinIcon version={4} color={colors.BLACK(0.5)} height={18} width={18} />,
    label: "Bounties",
    value: "bounties",
  },
  {
...
export const getTabs = ({ router, document }: { router: NextRouter, document: GenericDocument }) => {
...
const withPillContent = ({ tabs, document }: { tabs: Array<Tab>, document: GenericDocument }) => {
  let finalTabs:Array<Tab> = []
...
const withSelected = ({ tabs, tabName }: { tabs: Array<Tab>, tabName: string }) => {
...
const withHref = ({ tabs, router }: { tabs: Array<Tab>, router: NextRouter }) => {
