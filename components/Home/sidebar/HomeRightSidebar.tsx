...
import { INFO_TAB_EXIT_KEY, SCICON_2023 } from "~/components/Banner/constants/exitable_banner_keys";
    ...
    <div className={css(styles.HomeRightSidebar)}>
      <ColumnContainer overrideStyles={styles.HomeRightSidebarContainer}>
        ...
        <ExitableBanner
          ...
          content={
          <Link href="researchhub.foundation/scicon" style={{ textDecoration: "none", color: "black" }}>
            <div style={{  background: "linear-gradient(to bottom, #B74A9C, #5235A3)", padding: 14, boxSizing: "border-box" }}>
                <RHLogo withText white />
                <div style={{ fontSize: 32, fontWeight: 600, marginTop: 15, color: "white" }}>
                  SciCon 2023
                </div>
                <div style={{ fontSize: 16, marginTop: 2, color: "white", fontWeight: 500 }}>September 23-24</div>
                <div style={{ marginTop: 20, background: "#FECD03", fontWeight: 500, padding: "12px 0px", width: "100%", display: "inline-block", borderRadius: 4, textAlign: "center" }}>Register Now</div>
            </div>
          </Link>  
        }
          contentStyleOverride={{
