...
import showSiteUpdatesToast from "~/components/Notifications/lib/showSiteUpdatesToast";
...
function Base({
  ...
  useEffect(() => {
    showSiteUpdatesToast({
      content: (
        <span>
          New profile pages, revamped RSC rewards, author expertise and more.
        </span>
      ),
    });
  }, []);
