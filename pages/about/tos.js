      ...
      <div className={css(styles.page)}>
        <ComponentWrapper>
          ...
          <p className={css(styles.paragraph)}>
            ...
            <strong>Services</strong>") provided by ResearchHub, Inc. ("
            <strong>ResearchHub</strong>," "<strong>we</strong>," or "
            <strong>us</strong>"). By participating in the ResearchHub Services
            (for example through posting content, reviewing or commenting on
            content, or acting as a moderator) you will have the opportunity to
            earn native ResearchCoin tokens (“[<strong>ResearchCoins]</strong>
            ”), as more fully described below and on the Services. The
            ResearchHub website includes additional policies and requirements
            regarding each of the foregoing, including processes and technical
            requirements for participating in the Services, policies regarding
            how to earn ResearchCoins, our Content Policy (as further defined
          ...
          <p className={css(styles.paragraph)}>
            ...
            of a company (such as your employer) or other legal entity, you
          ...
          <p className={css(styles.paragraph)}>
            <strong>
              ...
              DISPUTE BETWEEN YOU AND US THROUGH BINDING, INDIVIDUAL ARBITRATION
              RATHER THAN IN COURT. PLEASE REVIEW CAREFULLY SECTION 13 (DISPUTE
          ...
          <p className={css(styles.paragraph, styles.indent)}>
            ...
            under applicable law. You may not establish an account or
            participate if you are resident in or a national of any country or
            region that is subject to a general trade embargo administered by
            the United States Office of Foreign Asset Controls, including Iran,
            Syria, Cuba, North Korea, or the Crimea Region of Ukraine.
            Additionally, if you are in the European Economic Area, you must be
            over the age required by the laws of your country to create an
            account or otherwise use the Services, or we need to have received
            verifiable consent from your parent or legal guardian. You cannot
            use the Services if you are not able to form legally binding
            contracts (for example, if you are under 18 years old); if you are
            temporarily or indefinitely suspended from using ResearchHub's
            websites, mobile apps, and other online products and services; or
          ...
          <p className={css(styles.paragraph, styles.indent)}>
            ...
            user identification, keys, and/or other credentials that will be
            used to associate you to the Services (collectively, “
            <strong>Credentials</strong>”). You are solely responsible for the
            security of your Credentials, are required to take appropriate
            measures to safeguard your Credentials, and will be responsible for
            any unauthorized access to or use of your Credentials. You will be
            solely responsible for all acts or omissions of any person using the
            Services or your Account with your Credentials. All transactions
            generated by use of your Credentials or originating from your
            Account will be deemed to be authorized by you. You will promptly
            notify ResearchHub if you discover or suspect that someone has
            accessed your Account without your permission. We recommend that you
            use a strong password that is used only with the Services. You will
          ...
          <p className={css(styles.paragraph, styles.indent)}>
            ...
            accurate and complete throughout your access to and use of the
            Services. Failure to provide or keep your information accurate,
          ...
          <p>
            ...
            stored as standard ERC-20 tokens publicly and permanently on the
            Ethereum blockchain. ResearchCoins are distributed on a monthly
            basis and are linked publicly to your username. The community can
            modify the distribution of ResearchCoins from the default
            distribution before the ResearchCoins are written into the Ethereum
          ...
          <p className={css(styles.paragraph)}>
            ...
            ResearchHub’s virtual goods or services. ResearchHub does not
            guarantee that ResearchCoins, or any virtual goods or services that
            ResearchCoins provide access to or use of (e.g., Promotion, and
            Grants), will continually be offered or will be available for any
          ...
          <p className={css(styles.paragraph)}>
            ...
            reputation score will be based upon a number of factors, as
            described in the ResearchHub Program Requirements. We reserve the
          ...
          <p className={css(styles.paragraph)}>
            ...
            REWARDS FROM RESEARCHHUB OR OTHERWISE IN CONNECTION WITH YOUR
            PARTRICIPARTION IN OR USE OF THE SERVICES. RESEARCHHUB DOES NOT
            GUARANTEE ANY ResearchCoin REWARDS WHATSOEVER, REGARDLESS OF THE
            AMOUNT OF TIME OR EFFORT INVOLVED IN YOUR PARTICIPATION IN THE
            SERVICES OR THE VALUE OF YOUR CONTENT. PARTICIPATION IN THE
          ...
          <p className={css(styles.paragraph)}>
            ...
            transaction details you submit via the Services will be completed.
            Once transaction details have been submitted to the Ethereum
            blockchain via the Services, we cannot assist you to cancel,
            reverse, or otherwise modify your transaction details. We strongly
          ...
          <p className={css(styles.paragraph)}>
            ...
            the Services will be subject to these Terms, as they may be updated
          ...
          <p className={css(styles.paragraph)}>
            ...
            your Account (“<strong>Your Content</strong>”). We take no
          ...
          <p className={css(styles.paragraph)}>
            ...
            conditions of the Creative Commons Attribution License (CC BY 4.0).
            This license allows anyone to reuse the content for any purpose, as
            long as attribution is provided. We consider a hyperlink or URL back
            to the source page on the ResearchHub Services sufficient
          ...
          <p className={css(styles.paragraph)}>
            ...
            organizations, or individuals who partner with ResearchHub. You also
            agree that we may remove metadata associated with Your Content, and
          ...
          <p className={css(styles.paragraph)}>
            ...
            these Terms, a violation of the Policy posted on our website, as may
          ...
          <p className={css(styles.paragraph)}>
            ...
            <strong>Third-Party Content</strong>”). Third-Party Content is not
            under our control, and we are not responsible for any such
            Third-Party Content. Your use of Third-Party Content is at your own
            risk and you should make any investigation you feel necessary before
          ...
          <p className={css(styles.paragraph)}>
            ...
            regulations. The terms of your promotion must specifically state
            that the promotion is not sponsored by, endorsed by, or associated
            with ResearchHub and the rules for your promotion must require each
          ...
          <ul>
            <li>
              Use the Services to violate applicable law or infringe any person
              or entity's intellectual property or any other proprietary rights;
            </li>
          </ul>
          <ul>
            <li>
              Attempt to gain unauthorized access to another user’s Account or
              to the Services (or to other computer systems or networks
          ...
          <ul>
            <li>
              ...
              applicable terms. However, we conditionally grant permission to
              crawl the Services for the sole purpose of and solely to the
              extent necessary for creating publicly available searchable
              indices of the materials subject to the parameters set forth in
              our robots.txt file.
            </li>
          </ul>
          <h2>
          ...
          <p className={css(styles.paragraph)}>
            ...
            take some work, so we may change the features or abilities
            associated with moderating from time to time without prior notice.
            We reserve the right to revoke or limit a user’s ability to moderate
          ...
          <ul>
            <li>
              ...
              that you will take action to moderate by removing content and/or
              escalating to the admins for review;
            </li>
          </ul>
          <ul>
            <li>
          ...
          <ul>
            <li>
              ...
              compensation or favor from third parties;
            </li>
          </ul>
          <ul>
            <li>
          ...
          <p className={css(styles.paragraph)}>
            ...
            users of our Services who are repeat infringers. If you believe that
            anything on our Services infringes a copyright that you own or
          ...
          <p className={css(styles.paragraph)}>
            ...
            counter notification to our Copyright Agent (contact information
          ...
          <p className={css(styles.paragraph)}>
            ...
            <strong>ResearchHub Entities</strong>”) harmless, including costs
            and attorneys’ fees, from any claim or demand made by any third
            party due to or arising out of (a) your use of the Services, (b)
            your violation of these Terms, (c) your violation of applicable laws
            or regulations, or (d) Your Content. We reserve the right to control
          ...
          <p className={css(styles.paragraph)}>
            ...
            PARTICULAR PURPOSE, AND NON-INFRINGEMENT. RESEARCHHUB, ITS
            LICENSORS, AND ITS THIRD PARTY SERVICE PROVIDERS DO NOT WARRANT THAT
            THE SERVICES ARE ACCURATE, COMPLETE, RELIABLE, CURRENT, OR ERROR
            FREE. RESEARCHHUB DOES NOT CONTROL, ENDORSE, OR TAKE RESPONSIBILITY
            FOR ANY CONTENT AVAILABLE ON OR LINKED TO THE SERVICES OR THE
            ACTIONS OF ANY THIRD PARTY OR USER, INCLUDING MODERATORS. WHILE
            RESEARCHHUB ATTEMPTS TO MAKE YOUR ACCESS TO AND USE OF OUR SERVICES
          ...
          <p className={css(styles.paragraph)}>
            ...
            NETWORK. YOU ASSUME FULL RESPONSIBILITY AND LIABILITY FOR ANY LOSSES
            FROM ANY INTENTIONAL OR UNINTENTIONAL MISUSE OF YOUR RESEARCHCOIN
            WALLET, INCLUDING ANY LOSS RESULTING FROM DESIGNATING A
            NON-COMPLIANT WALLET FOR THE RECEIPT OF TOKENS, DEPOSITING OR
            STAKING TOKENS TO A NON-COMPLIANT WALLET OR NON-EXISTENT WALLET, OR
            ERRORS OR TYPOS IN ANY WALLET ADDRESSES THAT YOU PROVIDE TO ANYONE.
            WE WILL NOT BE LIABLE TO YOU FOR ANY LOSSES ARISING OUT OF OR IN
            CONNECTION WITH (I) ACTS OR OMISSIONS BY YOU, (II) SOFTWARE BUGS,
            ERRORS, OR DOWNTIME IN THE ETHEREUM NETWORK OR THE BLOCKCHAIN
            NETWORK UNDERLYING ResearchCoinS, (III) FORKS TO THE ETHEREUM
          ...
          <p className={css(styles.paragraph)}>
            ...
            RESEARCHHUB ENTITIES EXCEED THE GREATER OF ONE HUNDRED U.S. DOLLARS
            ($100) OR ANY AMOUNT YOU PAID RESEARCHHUB IN THE PREVIOUS SIX MONTHS
            ...
            OTHERWISE, AND EVEN IF THE RESEARCHHUB ENTITIES HAVE BEEN ADVISED OF
            THE POSSIBILITY OF ANY SUCH DAMAGE, AND EVEN IF ANY REMEDY SET FORTH
          ...
          <p className={css(styles.paragraph)}>
            ...
            Except as set forth below with respect to arbitration, all disputes
          ...
          <p className={css(styles.paragraph, styles.indent)}>
            ...
            validity thereof or the use of the Services or Content
            (collectively, “<strong>Disputes</strong>”) will be resolved solely
            by binding, individual arbitration and not in a class,
            representative or consolidated action or proceeding. You and we
            agree that the U.S. Federal Arbitration Act governs the
            interpretation and enforcement of these Terms, and that you and we
          ...
          <p className={css(styles.paragraph, styles.indent)}>
            ...
            Dispute is for less than $10,000, unless the arbitrator finds your
          ...
          <p className={css(styles.paragraph, styles.indent)}>
            ...
            indicated in the “Last Updated” date above or in the date of our
            ...
            us in accordance with the terms of this Section 13 (Dispute
          ...
          <p className={css(styles.paragraph)}>
            ...
            address associated with your Account (if you have chosen to provide
            an email address) or by otherwise providing notice through our
