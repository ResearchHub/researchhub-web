        ...
        <div className={css(styles.mainContent)}>
          ...
          <div className={css(styles.feedSection)}>
            <div className={css(styles.header)}>
              <h1 className={css(styles.title)}>ResearchHub Journal (Preprints in review)</h1>
              <p className={css(styles.description)}>
                Provides preprints in biological sciences, including subfields like neuroscience, genomics, and physiology. We incentivize peer reviewers to provide feedback in the open because we believe that science is best served by open and transparent communication.
              </p>
