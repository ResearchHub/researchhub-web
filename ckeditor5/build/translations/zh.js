(function(e) {
  ...
  t.dictionary = Object.assign(t.dictionary || {}, {
    ...
    Column: "欄",
    Comment: "留言",
    "Comment editor": "留言編輯器",
    CONNECTED_USERS: "%0 位已連線使用者。",
    "Decrease indent": "減少縮排",
    "Delete column": "刪除欄",
    "Delete comment thread?": "刪除討論串？",
    "Delete comment?": "刪除留言？",
    "Delete row": "刪除列",
    "Dim grey": "淡灰色",
    Downloadable: "可下載",
    ...
    PENDING_ACTION_COMMENT_THREAD: "討論串尚未儲存。",
    PENDING_ACTION_SENDING_DATA: "傳送資料到伺服器。",
    "Plain text": "純文字",
    Previous: "上一",
    Purple: "紫色",
    Red: "紅色",
    ...
    "Tip: Paste the URL into the content to embed faster.":
      "提示：在內容貼上網址更快崁入。",
    TOO_LONG_COMMENT_ALERT: "留言內容太長。你的留言有 %0 個字，上限字數為 %1。",
    Turquoise: "藍綠色",
    Undo: "取消",
    Unlink: "移除連結",
    Update: "",
