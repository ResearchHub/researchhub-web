(function(e) {
  ...
  t.dictionary = Object.assign(t.dictionary || {}, {
    ...
    Column: "",
    Comment: "의견",
    "Comment editor": "의견 편집기",
    CONNECTED_USERS: "%0명의 연결된 사용자",
    "Decrease indent": "들여쓰기 줄이기",
    "Delete column": "",
    "Delete comment thread?": "의견 글타래를 삭제할까요?",
    "Delete comment?": "의견을 삭제할까요?",
    "Delete row": "",
    "Dim grey": "진한 회색",
    ...
    PENDING_ACTION_COMMENT_THREAD:
      "의견 글타래에 저장되지 않은 변경 사항이 있습니다.",
    PENDING_ACTION_SENDING_DATA: "서버로 데이터를 보내고 있습니다.",
    "Plain text": "평문",
    Previous: "이전",
    Purple: "보라색",
    Red: "빨간색",
    ...
    TOO_LONG_COMMENT_ALERT:
      "의견의 내용이 너무 깁니다. 작성하신 내용의 길이는 %0자이지만 제한은 %1자입니다.",
    Turquoise: "청록색",
    Undo: "실행 취소",
    Unlink: "링크 삭제",
    Update: "",
