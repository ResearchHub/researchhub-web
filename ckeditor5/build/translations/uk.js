(function(e) {
  ...
  t.dictionary = Object.assign(t.dictionary || {}, {
    ...
    Column: "Стовпець",
    Comment: "Коментар",
    "Comment editor": "Редактор коментарів",
    CONNECTED_USERS: [
      "1 під'єднаних користувач (я)",
      "%0 під'єднаних користувачів",
      "%0 під'єднаних користувачів",
      "%0 під'єднаних користувачів",
    ],
    "Decrease indent": "Зменшити відступ",
    "Delete column": "Видалити стовпець",
    "Delete comment thread?": "Видати ланцюжок коментарів?",
    ...
    PENDING_ACTION_COMMENT_THREAD: "Незбережена зміна ланцюжка коментарів.",
    PENDING_ACTION_SENDING_DATA: "Надсилання даних на сервер.",
    ...
    TOO_LONG_COMMENT_ALERT:
      "Коментар задовгий. Ваш коментар містить %0 знак із %1 допустимих.",
    Turquoise: "Бірюзовий",
    Undo: "Відміна",
